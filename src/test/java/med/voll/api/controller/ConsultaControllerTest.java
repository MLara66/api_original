...
class ConsultaControllerTest {
  ...
  void agendarEscenario2() throws Exception {
    ...
    var datos = new DatosDetalleConsulta(null,5l,1l,fecha);
    ...
    var response = mvc.perform(post("/consultas")
        ...
        .content(agendarConsultaJacksonTester.write(new DatosAgendarConsulta(5l,1l,fecha, especialidad)).getJson())
